function questionApp() {
  ...
  function finalScore() {
    ...
    finalScoreText.innerHTML = "你最后得分 " + score+ '<br>' + " 回答问题数" + questionCount;

    var resetButton = document.createElement("button");
    finalScore.appendChild(resetButton);
    var resetLabel = document.createTextNode("再试一次");
  ...
  function generateQuestion() {
    ...
    questionTitle.innerHTML = "问题 " + currentQuestion + ": " + selectedQuestion.question;
